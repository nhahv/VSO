...
import com.nhahv.vso.icons.VSOIcon;
 ...
 */
@Tag("TFS")
public class VSORepository extends BaseRepositoryImpl {
    ...
    public VSORepository() {
    }

    public VSORepository(TaskRepositoryType type) {
        super(type);
    ...
    public BaseRepository clone() {
        return new VSORepository(this);
    }

    private VSORepository(VSORepository other) {
        super(other);
    ...
    @Override
    public Task[] getIssues(@Nullable String query, int i, long l) throws Exception {
...
*/
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VSORepository)) return false;

        VSORepository that = (VSORepository)o;
        return true;
    }
}